...
namespace Ploosqva.ProjectBase.NHibernate.Fluent.SessionMgmt
{
    ...
    public sealed class FluentNhSessionManager
    {
        ...
        public static FluentNhSessionManager Instance
        {
            get
            {
                return Nested.FluentNhSessionManager;
            }
        }
        ...
        {
            Check.Require(Config != null, "Fluent configuration cannot be null");

            sessionFactory = (Config as FluentConfiguration).BuildSessionFactory();
        }
